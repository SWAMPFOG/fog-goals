        ...
        {profile && (
          <section className="mb-4 rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              ...
              {profile.role === "team_manager" && profile.team_id && <><Link href={`/teams/${profile.team_id}`} className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">TEAM</p><p className="mt-1 font-bold">自チーム</p></Link><Link href="/clients" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">CLIENT SALES</p><p className="mt-1 font-bold">クライアント売上</p></Link><Link href="/daily" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">DAILY</p><p className="mt-1 font-bold">日報入力</p></Link></>}
              {profile.role === "department_manager" && profile.department_id && <><Link href={`/departments/${profile.department_id}`} className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">DEPARTMENT</p><p className="mt-1 font-bold">担当営業部</p></Link><Link href="/teams" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">TEAMS</p><p className="mt-1 font-bold">チーム確認</p></Link><Link href="/clients" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">CLIENT SALES</p><p className="mt-1 font-bold">クライアント売上</p></Link><Link href="/daily" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">DAILY</p><p className="mt-1 font-bold">日報確認</p></Link></>}
              {storeView && <><Link href="/teams" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">TEAMS</p><p className="mt-1 font-bold">全チーム</p></Link><Link href="/members" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">MEMBERS</p><p className="mt-1 font-bold">全メンバー</p></Link><Link href="/clients" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">CLIENT SALES</p><p className="mt-1 font-bold">クライアント売上</p></Link><Link href="/daily" className="rounded-2xl border border-zinc-800 p-4"><p className="text-xs text-zinc-500">DAILY</p><p className="mt-1 font-bold">日報管理</p></Link><Link
          href="/summary"
