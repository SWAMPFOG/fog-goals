...
export default function MembersPage() {
  ...
  const [teamName, setTeamName] = useState("黄昏チーム");
  ...
  useEffect(() => {
    async function loadMembers() {
      ...
      if (!profile?.team_id) {
        setTeamName("PROFILE TEAM_ID: NULL");
        setLoading(false);
        return;
      }

      setTeamName("PROFILE TEAM_ID: " + profile.team_id);
